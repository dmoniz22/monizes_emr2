...
<% } %>
    ...
    <tr>
      <td style="vertical-align:top"><strong><a href="#" onclick="openBrWindow('./ticklerSuggestedText.jsp','','width=680,height=400')" style="font-weight:bold"><bean:message key="tickler.ticklerEdit.suggestedText"/></a>:</strong></td>
      <td style="vertical-align:top">

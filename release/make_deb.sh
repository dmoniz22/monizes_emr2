...
# v 98 - Change config to not comment out DOCUMENT_DIR, also updated patch.sql for truncation errors
# v 99 - Updated patch19.sql to support pronoun, initial OpenO_compatibility.sql
...
cp -R OpenO_compatibility.sql ./${DEBNAME}/usr/share/${PACKAGE}/OpenO_compatibility.sql
